...
def evaluate_debug(rx_samples, meta_content):
    ...
    np.save("convolutionalsample001_8db.npy", viterbi_out)
    print("\n✅ Decoded bits saved to 'convolutionalsample001_8db.npy'")
...
if __name__ == "__main__":
    RX_PATH = "/Users/Dell/Desktop/icarsus/cubesat_dataset/phase3_coding/convolutional/snr_8db/sample_001/rx.npy"
    META_PATH = "/Users/Dell/Desktop/icarsus/cubesat_dataset/phase3_coding/convolutional/snr_8db/sample_001/meta.json"
