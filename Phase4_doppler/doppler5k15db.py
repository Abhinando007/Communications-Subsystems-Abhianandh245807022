...
OUTPUT_BITS_NPY = os.path.join(OUTPUT_DIR, "doppler5000Hz15db.npy")
OUTPUT_BITS_TXT = os.path.join(OUTPUT_DIR, "doppler5000Hz15db.txt")
OUTPUT_LLRS     = os.path.join(OUTPUT_DIR, "recovered_llrs515.npy")
...
if __name__ == "__main__":
    if in_notebook():
        ...
        OUTPUT_BITS_NPY = os.path.join(args.out_dir, "doppler5000Hz15db.npy")
        OUTPUT_BITS_TXT = os.path.join(args.out_dir, "doppler5000Hz15db.txt")
        OUTPUT_LLRS     = os.path.join(args.out_dir, "recovered_llrs5k15.npy")
